...
// glam 0.33 changed Vec2 alignment; just verify it compiles correctly
#[allow(non_upper_case_globals)]
const _verify_glam_alignments: () = {
    let _ = core::mem::align_of::<glam::Vec2>();
    let _ = core::mem::align_of::<glam::Vec3>();
    let _ = core::mem::align_of::<glam::Vec4>();
};
